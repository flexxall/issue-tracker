      ...
      <Card className="col-12">
        <Row className="pt-2">
          <Col className="col-sm-10">
            <CardText>
              Assigned To: <span>Username firstname lastname</span>
            </CardText>
          </Col>
        ...
        <Row className="pt-2">
          <CardText className="description-text">
            ...
            reported. Disregard any spelling errors in here. Just more text to
            fill up a few lines of text so there is some body to the issues
            reported.
          </CardText>
        </Row>
      </Card>
